...
class PasswordConfirmationTest extends TestCase
{
    ...
    public function test_check_confirmed_password_status()
    {
    ...
    public function test_check_confirmed_password_status_from_api()
    {
    ...
    public function test_password_can_be_confirmed_from_api()
    {
        $token = User::factory()->create()->createToken('Test Token')->plainTextToken;
    ...
    public function test_password_is_not_confirmed_with_invalid_password_from_api()
    {
        $token = User::factory()->create()->createToken('Test Token')->plainTextToken;
